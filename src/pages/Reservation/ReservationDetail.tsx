  ...
  return (
    ...
    >
      ...
      >
        ...
        <Divider sx={{ my: 0.5 }} />
        <Box sx={{ marginLeft: "25%", width: "75%" }}>
          <Typography variant="h6" sx={{ mt: 0, fontSize: { xs: 20, sm: 24 } }}>
            Customer
          </Typography>
        ...
        <Box sx={{ marginLeft: "25%", width: "75%" }}>
          ...
          <Typography sx={{ fontSize: { xs: 18, sm: 20 } }}>
            Price:{" "}
            {reservation.price !== undefined ? `$${reservation.price}` : "N/A"}
          </Typography>
          <Typography sx={{ fontSize: { xs: 18, sm: 20 } }}>
            Adults:{" "}
        ...
        <Box sx={{ marginLeft: "25%", width: "75%", mt: 2 }}>
          <Button
            variant="contained"
            size="large"
            startIcon={<RestaurantMenuIcon />}
            onClick={() => navigate(`/reservation/${id}/menu`)}
            sx={{
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
            Choose your dishes for this reservation
          </Typography>
        </Box>
      </Paper>
    </Box>
